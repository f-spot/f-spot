	...
	public class Profile : IDisposable
	{
		...
		public string Model {
			get {
				lock (srgb) {
					...
					var _ = NativeMethods.CmsGetProfileInfo (Handle, NativeMethods.CmsProfileInfo.Model, "en", "US", ret, ret.Capacity);
					return ret.ToString ();
				}
			}
		}
		...
		public string ProductName {
			get {
				lock (srgb) {
					var ret = new StringBuilder (128);
					var _ = NativeMethods.CmsGetProfileInfo (Handle, NativeMethods.CmsProfileInfo.Manufacturer, "en", "US", ret, ret.Capacity);
					return ret.ToString ();
				}
			}
		}
		...
		public string ProductDescription {
			get {
				lock (srgb) {
					var ret = new StringBuilder (128);
					var _ = NativeMethods.CmsGetProfileInfo (Handle, NativeMethods.CmsProfileInfo.Description, "en", "US", ret, ret.Capacity);
					return ret.ToString ();
				}
			}
		}
		...
		protected virtual void Dispose (bool disposing)
		{
			...
			var _ = NativeMethods.CmsCloseProfile (Handle);
		}
