...
namespace FSpot.Migrations
{
    public partial class InitialCreation : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Tags",
                columns: new[] { "Id", "Icon", "IsCategory", "Name", "ParentId", "PhotoId", "SortPriority" },
                values: new object[] { new Guid("920caad8-6480-4d8c-9e0a-468c94e777c1"), "emblem-favorite", true, "Favorites", new Guid("00000000-0000-0000-0000-000000000000"), null, -10L });

            migrationBuilder.InsertData(
                table: "Tags",
                columns: new[] { "Id", "Icon", "IsCategory", "Name", "ParentId", "PhotoId", "SortPriority" },
                values: new object[] { new Guid("8d8c0f4d-2fe4-4627-ac9a-7c273004b3b5"), "emblem-readonly", false, "Hidden", new Guid("00000000-0000-0000-0000-000000000000"), null, -9L });

            migrationBuilder.InsertData(
                table: "Tags",
                columns: new[] { "Id", "Icon", "IsCategory", "Name", "ParentId", "PhotoId", "SortPriority" },
                values: new object[] { new Guid("d67b6807-f635-4e6b-a98a-8a9f18966647"), "emblem-people", true, "People", new Guid("00000000-0000-0000-0000-000000000000"), null, -8L });

            migrationBuilder.InsertData(
                table: "Tags",
                columns: new[] { "Id", "Icon", "IsCategory", "Name", "ParentId", "PhotoId", "SortPriority" },
                values: new object[] { new Guid("83128847-fd1e-4a5b-9294-3977a031f4f1"), "emblem-places", true, "Places", new Guid("00000000-0000-0000-0000-000000000000"), null, -7L });

            migrationBuilder.InsertData(
                table: "Tags",
                columns: new[] { "Id", "Icon", "IsCategory", "Name", "ParentId", "PhotoId", "SortPriority" },
                values: new object[] { new Guid("da4b6643-50c4-4721-908d-ed2fe09feade"), "emblem-event", true, "Events", new Guid("00000000-0000-0000-0000-000000000000"), null, -6L });
